...
public final class TagElement implements Element, Iterable<Element> {
    ...
    public boolean equals(Object o) {
        if (o instanceof TagElement elements) {
            return useSelfClosing == elements.useSelfClosing
                && Objects.equals(tagName, elements.tagName)
                && attributes.equals(elements.attributes)
                && children.equals(elements.children);
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        int result = Objects.hashCode(tagName);
        result = 31 * result + Boolean.hashCode(useSelfClosing);
